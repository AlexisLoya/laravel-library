...
//                    }
    ...
    {
        $request->user()->tokens()->first()->delete(); //Revoke all tokens
        return response()->json([
    ...
    public function changePassword(Request  $request){
        ...
        foreach ($request->user()->tokens as $token) { //Revoke all previous tokens
            $token->delete();
        }
        return $this->getResponse200('Password changed successfully');
    }
